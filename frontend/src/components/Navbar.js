...
export default function Navbar() {
  ...
  <div className="flex-1 flex flex-row ">
    <main className="flex-1 dark:bg-slate-900 ">Content here</main>

    <nav className="order-first sm:w-60 bg-purple-200   dark:bg-slate-900">
    ...
    <aside className="sm:w-60 dark:bg-slate-900"><div class=' justify-end flex-col min-h-screen dark:bg-slate-900'>
    <div class='break-inside relative overflow-hidden flex flex-col justify-between space-y-2 text-sm rounded-xl max-w-[23rem] p-4 mb-4 dark:bg-slate-800 text-white'>
